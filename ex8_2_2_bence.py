...
# Extracing the X matrix from the data set (every column exlcuding age)
X = np.delete(data,[8],1)
#X = data[:, 1:10]



# age attrbiute will be the y-vector
y = np.delete(data,[0,1,2,3,4,5,6,7,9],1)

####################

# read XOR DATA from matlab datafile
mat_data = loadmat(r'C:\Users\User\OneDrive\School\MachineLearning&DataMining\02450Toolbox_Python\Data\xor.mat')
#X = mat_data['X']
#y = mat_data['y']
...
for k, (train_index, test_index) in enumerate(CV.split(X,y)): 
    ...
    """
    # This only works for 2 feature datasets for visualization
